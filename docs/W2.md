...
------------ | ------------- | ------------- | -------------
**employer** | Option<[**models::PaystubEmployer**](PaystubEmployer.md)> |  | [optional]
...
**box_12** | Option<[**Vec<models::W2Box12>**](W2Box12.md)> |  | [optional]
...
**state_and_local_wages** | Option<[**Vec<models::W2StateAndLocalWages>**](W2StateAndLocalWages.md)> |  | [optional]
