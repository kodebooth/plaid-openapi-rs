...
**holdings** | [**Vec<models::Holding>**](Holding.md) | The holdings belonging to the investment account. Details of the securities in the holdings are provided in the `securities` field. | 
**securities** | [**Vec<models::Security>**](Security.md) | Objects describing the securities held in the account. | 
**owners** | [**Vec<models::InvestmentsAuthOwner>**](InvestmentsAuthOwner.md) | Information about the account owners for the account. | 
