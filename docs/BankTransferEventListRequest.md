...
**bank_transfer_type** | Option<**BankTransferType**> | The type of bank transfer. This will be either `debit` or `credit`.  A `debit` indicates a transfer of money into your origination account; a `credit` indicates a transfer of money out of your origination account. (enum: debit, credit, ) | [optional]
...
**direction** | Option<**Direction**> | Indicates the direction of the transfer: `outbound`: for API-initiated transfers `inbound`: for payments received by the FBO account. (enum: inbound, outbound, ) | [optional]
