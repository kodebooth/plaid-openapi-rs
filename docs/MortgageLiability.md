...
**maturity_date** | Option<**chrono::NaiveDate**> | Original date on which mortgage is due in full. Dates are returned in an ISO 8601 format (YYYY-MM-DD). | 
**next_monthly_payment** | Option<**f64**> | The amount of the next payment. | 
**next_payment_due_date** | Option<**chrono::NaiveDate**> | The due date for the next payment. Dates are returned in an ISO 8601 format (YYYY-MM-DD). | 
