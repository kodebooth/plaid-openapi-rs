...
**transfer_type** | Option<[**models::TransferEventListTransferType**](TransferEventListTransferType.md)> |  | [optional]
**event_types** | Option<[**Vec<models::TransferEventType>**](TransferEventType.md)> | Filter events by event type. | [optional]
