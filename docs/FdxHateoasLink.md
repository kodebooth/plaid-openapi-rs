...
**action** | Option<[**models::FdxHateoasLinkAction**](FDXHateoasLinkAction.md)> |  | [optional]
...
**types** | Option<[**Vec<models::FdxContentTypes>**](FDXContentTypes.md)> | Content-types that can be used in the Accept header | [optional]
