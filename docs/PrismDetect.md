...
------------ | ------------- | ------------- | -------------
**model_version** | **String** | The version of Prism Data's CashScore® Detect model used. | 
**score** | Option<**i32**> | The score returned by Prism Data. Ranges from 1-999, with higher score indicating lower risk. | 
**reason_codes** | Option<**Vec<String>**> | The reasons for an individual having risk according to the CashScore® Detect score. | [optional]
