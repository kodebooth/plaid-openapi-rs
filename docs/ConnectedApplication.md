...
**created_at** | **String** | The date this application was linked in ISO8601 (YYYY-MM-DD) format in UTC. | 
**product_data_types** | **Vec<ProductDataTypes>** | (Deprecated) A list of enums representing the data collected and products enabled for this connected application. (enum: ACCOUNT_BALANCE, ACCOUNT_USER_INFO, ACCOUNT_TRANSACTIONS) | 
**scopes** | Option<[**models::ScopesNullable**](ScopesNullable.md)> |  | [optional]
**requested_scopes** | Option<[**models::RequestedScopes**](RequestedScopes.md)> |  | [optional]
