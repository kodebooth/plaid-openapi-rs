...
**parsing_config** | [**Vec<models::IncomeVerificationDocParsingConfig>**](IncomeVerificationDocParsingConfig.md) | The types of analysis to enable for the document income verification session | 
