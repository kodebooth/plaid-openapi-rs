...
**insights** | Option<[**models::AccountInsights**](AccountInsights.md)> |  | [optional]
**client_report_id** | Option<**String**> | An identifier you determine and submit for the Asset Report. | 
**date_generated** | **chrono::DateTime<chrono::FixedOffset>** | The date and time when the Asset Report was created, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (e.g. \"2018-04-12T03:32:11Z\"). | 
