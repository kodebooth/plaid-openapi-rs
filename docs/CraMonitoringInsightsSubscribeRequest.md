...
**item_id** | Option<**String**> | The item ID to subscribe for Cash Flow Updates. | [optional]
**webhook** | **String** | URL to which Plaid will send Cash Flow Updates webhooks, for example when the requested Cash Flow Updates report is ready. | 
**income_categories** | Option<[**Vec<models::CreditBankIncomeCategory>**](CreditBankIncomeCategory.md)> | Income categories to include in Cash Flow Updates. If empty or `null`, this field will default to including all possible categories. | [optional]
