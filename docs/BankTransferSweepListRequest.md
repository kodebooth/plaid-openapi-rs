...
**start_time** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The start `created` datetime of sweeps to return (RFC 3339 format). | [optional]
**end_time** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The end `created` datetime of sweeps to return (RFC 3339 format). | [optional]
