...
------------ | ------------- | ------------- | -------------
**current** | Option<[**models::CraCurrentModeledIncome**](CraCurrentModeledIncome.md)> |  | 
**projected** | Option<[**models::CraProjectedModeledIncome**](CraProjectedModeledIncome.md)> |  | 
