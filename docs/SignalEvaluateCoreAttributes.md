...
**balance_last_updated** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Timestamp in ISO-8601 format (YYYY-MM-DDTHH:mm:ssZ) indicating the last time that the balance for the given account has been updated. | [optional]
