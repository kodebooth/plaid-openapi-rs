...
------------ | ------------- | ------------- | -------------
**date** | **chrono::NaiveDate** | Posting date for the transaction. Must be formatted as an [ISO 8601](https://wikipedia.org/wiki/ISO_8601) date. | 
...
**security** | Option<[**models::SecurityOverride**](SecurityOverride.md)> |  | [optional]
