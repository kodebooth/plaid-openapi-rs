...
**authorized_date** | Option<**chrono::NaiveDate**> | The date that the transaction was authorized. Dates are returned in an ISO 8601 format ( `YYYY-MM-DD` ). | 
**authorized_datetime** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Date and time when a transaction was authorized in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`. | 
**datetime** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Date and time when a transaction was posted in ISO 8601 format ( `YYYY-MM-DDTHH:mm:ssZ` ).  This field is only populated for UK institutions. For institutions in other countries, will be `null`. | 
