...
**is_diligence_attested** | Option<**bool**> | Denotes whether or not the partner has completed attestation of diligence for the end customer to be created. | [optional]
...
**legal_entity_name** | Option<**String**> | The end customer's legal name. This will be shared with financial institutions as part of the OAuth registration process. It will not be shown to end users. | [optional]
...
**customer_support_info** | [**models::PartnerEndCustomerCustomerSupportInfo**](PartnerEndCustomerCustomerSupportInfo.md) |  | 
