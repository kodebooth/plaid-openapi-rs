...
**search_terms** | Option<[**models::UpdateEntityScreeningRequestSearchTerms**](UpdateEntityScreeningRequestSearchTerms.md)> |  | [optional]
...
**reset_fields** | Option<[**Vec<models::WatchlistScreeningEntityUpdateRequestResettableField>**](WatchlistScreeningEntityUpdateRequestResettableField.md)> | A list of fields to reset back to null | [optional]
