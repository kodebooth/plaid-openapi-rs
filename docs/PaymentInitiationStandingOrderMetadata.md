...
**valid_standing_order_intervals** | [**Vec<models::PaymentScheduleInterval>**](PaymentScheduleInterval.md) | A list of the valid standing order intervals supported by the institution. | 
