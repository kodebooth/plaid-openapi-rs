...
**date_of_birth** | Option<**chrono::DateTime<chrono::FixedOffset>**> | To be provided in the format \"yyyy-mm-dd\". This field is optional and will support not-yet-implemented functionality for new products. | [optional]
