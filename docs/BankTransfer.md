...
**ach_class** | [**models::AchClass**](ACHClass.md) |  | 
**account_id** | **String** | The account ID that should be credited/debited for this bank transfer. | 
**r#type** | [**models::BankTransferType**](BankTransferType.md) |  | 
**user** | [**models::BankTransferUser**](BankTransferUser.md) |  | 
...
**created** | **chrono::DateTime<chrono::FixedOffset>** | The datetime when this bank transfer was created. This will be of the form `2006-01-02T15:04:05Z` | 
**status** | [**models::BankTransferStatus**](BankTransferStatus.md) |  | 
**network** | [**models::BankTransferNetwork**](BankTransferNetwork.md) |  | 
