...
------------ | ------------- | ------------- | -------------
**employer** | Option<[**models::PaystubOverrideEmployer**](PaystubOverrideEmployer.md)> |  | [optional]
**employee** | Option<[**models::PaystubOverrideEmployee**](PaystubOverrideEmployee.md)> |  | [optional]
**tax_year** | Option<**String**> | The tax year of the W2 document. | [optional]
**employer_id_number** | Option<**String**> | An employer identification number or EIN. | [optional]
...
**box_12** | Option<[**Vec<models::W2Box12Override>**](W2Box12Override.md)> |  | [optional]
...
**state_and_local_wages** | Option<[**Vec<models::W2StateAndLocalWagesOverride>**](W2StateAndLocalWagesOverride.md)> |  | [optional]
