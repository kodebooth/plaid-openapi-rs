...
**start_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The start `created` datetime of sweeps to return (RFC 3339 format). | [optional]
**end_date** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The end `created` datetime of sweeps to return (RFC 3339 format). | [optional]
...
**amount** | Option<**String**> | Filter sweeps to only those with the specified amount. | [optional]
...
**transfer_id** | Option<**String**> | Filter sweeps to only those with the included `transfer_id`. | [optional]
