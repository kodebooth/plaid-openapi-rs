...
**third_party_user_token** | Option<**String**> | The third-party user token associated with the requested User data. | [optional]
...
**user_tier** | Option<[**models::CraUserTier**](CraUserTier.md)> |  | [optional]
**partner_insights** | Option<[**models::CraCheckReportPartnerInsightsGetPartnerInsights**](CraCheckReportPartnerInsightsGetPartnerInsights.md)> |  | [optional]
**options** | Option<[**models::CraCheckReportPartnerInsightsGetOptions**](CraCheckReportPartnerInsightsGetOptions.md)> |  | [optional]
