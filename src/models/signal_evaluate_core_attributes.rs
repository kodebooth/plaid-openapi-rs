...
pub struct SignalEvaluateCoreAttributes {
    ...
    pub balance_last_updated: Option<Option<chrono::DateTime<chrono::FixedOffset>>>,
    ...
    pub transactions_last_updated: Option<Option<chrono::DateTime<chrono::FixedOffset>>>,
    ...
    #[serde(rename = "balance_to_transaction_amount_ratio", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub balance_to_transaction_amount_ratio: Option<Option<f64>>,
}
...
impl SignalEvaluateCoreAttributes {
    ...
    pub fn new() -> SignalEvaluateCoreAttributes {
        SignalEvaluateCoreAttributes {
            ...
            balance_to_transaction_amount_ratio: None,
        }
    }
}
