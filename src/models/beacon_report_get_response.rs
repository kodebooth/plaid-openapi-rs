...
impl BeaconReportGetResponse {
    ...
    pub fn new(id: String, beacon_user_id: String, created_at: chrono::DateTime<chrono::FixedOffset>, r#type: models::BeaconReportType, fraud_date: Option<chrono::NaiveDate>, event_date: chrono::NaiveDate, fraud_amount: Option<models::FraudAmount>, audit_trail: models::BeaconAuditTrail, request_id: String) -> BeaconReportGetResponse {
