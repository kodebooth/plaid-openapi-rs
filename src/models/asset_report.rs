...
pub struct AssetReport {
    ...
    pub insights: Option<Option<models::AccountInsights>>,
...
impl AssetReport {
    ...
    pub fn new(asset_report_id: String, client_report_id: Option<String>, date_generated: chrono::DateTime<chrono::FixedOffset>, days_requested: f64, user: models::AssetReportUser, items: Vec<models::AssetReportItem>) -> AssetReport {
        AssetReport {
            asset_report_id,
            insights: None,
            client_report_id,
