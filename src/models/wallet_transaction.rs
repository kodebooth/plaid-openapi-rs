...
impl WalletTransaction {
    ...
    pub fn new(transaction_id: String, wallet_id: String, reference: String, r#type: Type, amount: models::WalletTransactionAmount, counterparty: models::WalletTransactionCounterparty, status: models::WalletTransactionStatus, created_at: chrono::DateTime<chrono::FixedOffset>, last_status_update: chrono::DateTime<chrono::FixedOffset>) -> WalletTransaction {
        WalletTransaction {
            transaction_id,
            wallet_id,
            reference,
