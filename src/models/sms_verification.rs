...
pub struct SmsVerification {
    ...
    pub initially_sent_at: Option<chrono::DateTime<chrono::FixedOffset>>,
    /// An ISO8601 formatted timestamp.
    #[serde(rename = "last_sent_at", deserialize_with = "Option::deserialize")]
    pub last_sent_at: Option<chrono::DateTime<chrono::FixedOffset>>,
    /// An ISO8601 formatted timestamp.
...
impl SmsVerification {
    ...
    pub fn new(status: models::SmsVerificationStatus, attempt: i32, phone_number: Option<String>, delivery_attempt_count: i32, solve_attempt_count: i32, initially_sent_at: Option<chrono::DateTime<chrono::FixedOffset>>, last_sent_at: Option<chrono::DateTime<chrono::FixedOffset>>, redacted_at: Option<chrono::DateTime<chrono::FixedOffset>>) -> SmsVerification {
        SmsVerification {
            status,
            attempt,
            phone_number,
