...
impl PaymentInitiationMetadata {
    ...
    pub fn new(supports_international_payments: bool, maximum_payment_amount: std::collections::HashMap<String, String>, supports_refund_details: bool, standing_order_metadata: Option<models::PaymentInitiationStandingOrderMetadata>) -> PaymentInitiationMetadata {
