...
pub struct TotalReportOutflowAmount {
...
impl TotalReportOutflowAmount {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportOutflowAmount {
