...
impl ExtendedRecipientMetadata {
    ...
    pub fn new(recipient_id: String, client_name: String, third_party_legal_name: String, category: String, joined_date: chrono::NaiveDate, connection_count: i32) -> ExtendedRecipientMetadata {
