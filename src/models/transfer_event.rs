...
pub struct TransferEvent {
    ...
    #[serde(rename = "intent_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub intent_id: Option<Option<String>>,
    /// The fee amount deducted from the original transfer during a wire return, if applicable.
    #[serde(rename = "wire_return_fee", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub wire_return_fee: Option<Option<String>>,
}

impl TransferEvent {
    /// Represents an event in the Transfers API.
    pub fn new(event_id: i32, timestamp: chrono::DateTime<chrono::FixedOffset>, event_type: models::TransferEventType, funding_account_id: Option<String>, transfer_id: String, origination_account_id: Option<String>, failure_reason: Option<models::TransferFailure>, sweep_id: Option<String>, sweep_amount: Option<String>, refund_id: Option<String>, originator_client_id: Option<String>) -> TransferEvent {
        TransferEvent {
            event_id,
            timestamp,
            event_type,
