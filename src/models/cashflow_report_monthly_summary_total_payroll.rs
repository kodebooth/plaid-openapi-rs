...
pub struct CashflowReportMonthlySummaryTotalPayroll {
...
impl CashflowReportMonthlySummaryTotalPayroll {
    /// The total amount of all payroll transactions during this month.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryTotalPayroll {
