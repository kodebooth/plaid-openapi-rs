...
pub struct LinkTokenCreateRequestAccountSubtypesCredit {
...
impl LinkTokenCreateRequestAccountSubtypesCredit {
    /// A filter to apply to `credit`-type accounts
    pub fn new() -> LinkTokenCreateRequestAccountSubtypesCredit {
