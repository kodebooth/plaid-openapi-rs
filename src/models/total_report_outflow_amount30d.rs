...
pub struct TotalReportOutflowAmount30d {
...
impl TotalReportOutflowAmount30d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportOutflowAmount30d {
