...
pub struct TotalReportOutflowAmount60d {
...
impl TotalReportOutflowAmount60d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportOutflowAmount60d {
