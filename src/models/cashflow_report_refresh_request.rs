...
pub struct CashflowReportRefreshRequest {
...
impl CashflowReportRefreshRequest {
    /// CashflowReportRefreshRequest defines the request schema for `/cashflow_report/refresh`
    pub fn new(access_token: String, days_requested: i32) -> CashflowReportRefreshRequest {
