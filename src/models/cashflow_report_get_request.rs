...
pub struct CashflowReportGetRequest {
    ...
    pub options: Option<Box<models::CashflowReportGetRequestOptions>>,
}

impl CashflowReportGetRequest {
    /// CashflowReportGetRequest defines the request schema for `/cashflow_report/get`
    pub fn new(access_token: String, days_requested: i32) -> CashflowReportGetRequest {
