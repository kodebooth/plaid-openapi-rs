...
impl PaymentStatusUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, payment_id: String, new_payment_status: models::PaymentInitiationPaymentStatus, old_payment_status: models::PaymentInitiationPaymentStatus, original_reference: Option<String>, original_start_date: Option<chrono::NaiveDate>, adjusted_start_date: Option<chrono::NaiveDate>, timestamp: chrono::DateTime<chrono::FixedOffset>, environment: models::WebhookEnvironmentValues) -> PaymentStatusUpdateWebhook {
