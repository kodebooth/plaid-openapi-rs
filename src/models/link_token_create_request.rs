...
pub struct LinkTokenCreateRequest {
    ...
    pub user: Option<Box<models::LinkTokenCreateRequestUser>>,
    ...
    #[serde(rename = "appearance_mode", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub appearance_mode: Option<Option<models::LinkTokenCreateRequestAppearanceMode>>,
    ...
    #[serde(rename = "cashflow_report", skip_serializing_if = "Option::is_none")]
    pub cashflow_report: Option<Box<models::LinkTokenCashflowReport>>,
...
impl LinkTokenCreateRequest {
    ...
    pub fn new(client_name: String, language: String, country_codes: Vec<models::CountryCode>) -> LinkTokenCreateRequest {
