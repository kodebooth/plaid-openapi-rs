...
pub struct BaseReportInvestmentHolding {
...
impl BaseReportInvestmentHolding {
    /// A securities holding at an institution.
    pub fn new(account_id: String, security_id: String, institution_price: f64, institution_value: f64, cost_basis: Option<f64>, quantity: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> BaseReportInvestmentHolding {
