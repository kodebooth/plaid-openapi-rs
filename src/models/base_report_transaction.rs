...
impl BaseReportTransaction {
    ...
    pub fn new(account_id: String, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, original_description: Option<String>, date: chrono::NaiveDate, pending: bool, transaction_id: String) -> BaseReportTransaction {
