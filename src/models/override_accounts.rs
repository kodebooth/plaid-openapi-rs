...
pub struct OverrideAccounts {
    ...
    #[serde(rename = "has_null_available_balance")]
    pub has_null_available_balance: bool,
...
impl OverrideAccounts {
    ...
    pub fn new(r#type: models::OverrideAccountType, subtype: Option<models::AccountSubtype>, starting_balance: f64, force_available_balance: f64, has_null_available_balance: bool, currency: String, meta: models::Meta, numbers: models::Numbers, transactions: Vec<models::TransactionOverride>, identity: models::OwnerOverride, liability: models::LiabilityOverride, inflow_model: models::InflowModel) -> OverrideAccounts {
        OverrideAccounts {
            r#type,
            subtype,
            starting_balance,
