...
impl CraLoanRegister {
    ...
    pub fn new(user_token: String, loan_id: String, r#type: models::CraLoanType, payment_schedule: models::CraLoanPaymentSchedule, opened_date: chrono::NaiveDate, opened_with_status: models::CraLoanOpenedStatus) -> CraLoanRegister {
        CraLoanRegister {
            user_token,
            loan_id,
            r#type,
