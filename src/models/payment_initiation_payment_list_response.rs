...
pub struct PaymentInitiationPaymentListResponse {
    ...
    pub next_cursor: Option<chrono::DateTime<chrono::FixedOffset>>,
...
impl PaymentInitiationPaymentListResponse {
    ...
    pub fn new(payments: Vec<models::PaymentInitiationPayment>, next_cursor: Option<chrono::DateTime<chrono::FixedOffset>>, request_id: String) -> PaymentInitiationPaymentListResponse {
