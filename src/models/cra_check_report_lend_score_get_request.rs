...
pub struct CraCheckReportLendScoreGetRequest {
    ...
    pub options: Option<Option<Box<models::CraCheckReportLendScoreGetOptions>>>,
}

impl CraCheckReportLendScoreGetRequest {
    /// CraCheckReportLendScoreGetRequest defines the request schema for `/cra/check_report/lend_score/get`.
    pub fn new() -> CraCheckReportLendScoreGetRequest {
