...
impl AssetReportTransaction {
    pub fn new(original_description: Option<String>, account_id: String, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, date: chrono::NaiveDate, pending: bool, transaction_id: String) -> AssetReportTransaction {
