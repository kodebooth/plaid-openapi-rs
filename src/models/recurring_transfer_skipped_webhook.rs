...
impl RecurringTransferSkippedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, recurring_transfer_id: String, authorization_decision: models::TransferAuthorizationDecision, skipped_origination_date: chrono::NaiveDate, environment: models::WebhookEnvironmentValues) -> RecurringTransferSkippedWebhook {
