...
pub struct AssetReportInvestmentTransaction {
...
impl AssetReportInvestmentTransaction {
    /// A transaction within an investment account.
    pub fn new(investment_transaction_id: String, account_id: String, security_id: Option<String>, date: chrono::NaiveDate, name: String, quantity: f64, vested_quantity: f64, vested_value: f64, amount: f64, price: f64, fees: Option<f64>, r#type: models::InvestmentTransactionType, subtype: models::InvestmentTransactionSubtype, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> AssetReportInvestmentTransaction {
