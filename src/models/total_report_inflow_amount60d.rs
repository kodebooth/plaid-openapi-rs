...
pub struct TotalReportInflowAmount60d {
...
impl TotalReportInflowAmount60d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportInflowAmount60d {
