...
pub struct CraCheckReportVerificationGetRequest {
...
impl CraCheckReportVerificationGetRequest {
    /// CraCheckReportVerificationGetRequest defines the request schema for `/cra/check_report/verification/get`.
    pub fn new(reports_requested: Vec<models::CraCheckReportVerificationGetReportType>) -> CraCheckReportVerificationGetRequest {
