...
pub struct LinkTokenCreateRequestAccountSubtypesInvestment {
...
impl LinkTokenCreateRequestAccountSubtypesInvestment {
    /// A filter to apply to `investment`-type accounts
    pub fn new() -> LinkTokenCreateRequestAccountSubtypesInvestment {
