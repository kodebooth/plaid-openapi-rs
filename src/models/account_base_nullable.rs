...
pub struct AccountBaseNullable {
...
impl AccountBaseNullable {
    /// A single account at a financial institution.
    pub fn new(account_id: String, balances: models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>) -> AccountBaseNullable {
        AccountBaseNullable {
            account_id,
            balances,
            mask,
