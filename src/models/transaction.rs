...
impl Transaction {
    ...
    pub fn new(pending_transaction_id: Option<String>, category_id: Option<String>, category: Option<Vec<String>>, location: models::Location, payment_meta: models::PaymentMeta, account_owner: Option<String>, name: String, account_id: String, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, date: chrono::NaiveDate, pending: bool, transaction_id: String, payment_channel: PaymentChannel, merchant_name: Option<String>, authorized_date: Option<chrono::NaiveDate>, authorized_datetime: Option<chrono::DateTime<chrono::FixedOffset>>, datetime: Option<chrono::DateTime<chrono::FixedOffset>>, transaction_code: Option<models::TransactionCode>) -> Transaction {
        Transaction {
