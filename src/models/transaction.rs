...
pub struct Transaction {
    ...
    #[serde(rename = "client_customization", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub client_customization: Option<Option<models::ClientCustomization>>,
}

impl Transaction {
    /// A representation of a transaction
    pub fn new(account_id: String, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, date: chrono::NaiveDate, location: models::Location, name: String, payment_meta: models::PaymentMeta, pending: bool, pending_transaction_id: Option<String>, account_owner: Option<String>, transaction_id: String, authorized_date: Option<chrono::NaiveDate>, authorized_datetime: Option<chrono::DateTime<chrono::FixedOffset>>, datetime: Option<chrono::DateTime<chrono::FixedOffset>>, payment_channel: PaymentChannel, transaction_code: Option<models::TransactionCode>) -> Transaction {
        Transaction {
            account_id,
            amount,
            iso_currency_code,
