...
impl BeaconUserAccountInsightsGetResponse {
    ...
    pub fn new(beacon_user_id: String, created_at: chrono::DateTime<chrono::FixedOffset>, updated_at: chrono::DateTime<chrono::FixedOffset>, bank_account_insights: models::BeaconBankAccounts, request_id: String) -> BeaconUserAccountInsightsGetResponse {
