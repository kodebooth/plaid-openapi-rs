...
impl InvestmentsHoldingsGetResponse {
    ...
    pub fn new(accounts: Vec<models::InvestmentAccount>, holdings: Vec<models::Holding>, securities: Vec<models::Security>, item: models::Item, request_id: String) -> InvestmentsHoldingsGetResponse {
