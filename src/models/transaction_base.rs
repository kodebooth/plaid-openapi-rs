...
impl TransactionBase {
    ...
    pub fn new(account_id: String, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, date: chrono::NaiveDate, pending: bool, transaction_id: String) -> TransactionBase {
        TransactionBase {
            account_id,
            amount,
            iso_currency_code,
