...
pub struct FdxNotification {
    ...
    #[serde(rename = "sentOn")]
    pub sent_on: chrono::DateTime<chrono::FixedOffset>,
...
impl FdxNotification {
    ...
    pub fn new(notification_id: String, r#type: models::FdxNotificationType, sent_on: chrono::DateTime<chrono::FixedOffset>, category: models::FdxNotificationCategory, notification_payload: models::FdxNotificationPayload) -> FdxNotification {
        FdxNotification {
            notification_id,
            r#type,
            subtype: None,
