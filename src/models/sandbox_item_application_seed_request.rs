...
pub struct SandboxItemApplicationSeedRequest {
...
impl SandboxItemApplicationSeedRequest {
    /// SandboxItemApplicationSeedRequest defines the request schema for `/sandbox/item/application/seed`
    pub fn new(access_token: String, application_id: String) -> SandboxItemApplicationSeedRequest {
