...
impl TransferSweep {
    ...
    pub fn new(id: String, funding_account_id: String, created: chrono::DateTime<chrono::FixedOffset>, amount: String, iso_currency_code: String, settled: Option<chrono::NaiveDate>) -> TransferSweep {
        TransferSweep {
            id,
            funding_account_id,
            ledger_id: None,
