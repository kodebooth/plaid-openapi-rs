...
pub struct InvestmentsAuthGetResponse {
    ...
    pub accounts: Vec<models::InvestmentAccount>,
...
impl InvestmentsAuthGetResponse {
    ...
    pub fn new(accounts: Vec<models::InvestmentAccount>, holdings: Vec<models::Holding>, securities: Vec<models::Security>, owners: Vec<models::InvestmentsAuthOwner>, numbers: models::InvestmentsAuthGetNumbers, data_sources: models::InvestmentsAuthDataSources, item: models::Item, request_id: String) -> InvestmentsAuthGetResponse {
