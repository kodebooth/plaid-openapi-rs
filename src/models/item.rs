...
impl Item {
    ...
    pub fn new(item_id: String, webhook: Option<String>, error: Option<models::PlaidError>, available_products: Vec<models::Products>, billed_products: Vec<models::Products>, consent_expiration_time: Option<chrono::DateTime<chrono::FixedOffset>>, update_type: UpdateType) -> Item {
        Item {
            item_id,
            institution_id: None,
