...
pub struct CashflowReportMonthlySummaryAverageDailyInflowAmount {
...
impl CashflowReportMonthlySummaryAverageDailyInflowAmount {
    /// The average daily sum of inflow transactions, calculated over the month. Always represented as a positive monetary amount.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryAverageDailyInflowAmount {
