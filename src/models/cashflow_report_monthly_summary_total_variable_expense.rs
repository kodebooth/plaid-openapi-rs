...
pub struct CashflowReportMonthlySummaryTotalVariableExpense {
...
impl CashflowReportMonthlySummaryTotalVariableExpense {
    /// The total amount of all variable expense transactions during this month.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryTotalVariableExpense {
