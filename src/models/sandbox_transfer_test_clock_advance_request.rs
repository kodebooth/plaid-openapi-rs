...
pub struct SandboxTransferTestClockAdvanceRequest {
    ...
    pub new_virtual_time: chrono::DateTime<chrono::FixedOffset>,
}

impl SandboxTransferTestClockAdvanceRequest {
    /// Defines the request schema for `/sandbox/transfer/test_clock/advance`
    pub fn new(test_clock_id: String, new_virtual_time: chrono::DateTime<chrono::FixedOffset>) -> SandboxTransferTestClockAdvanceRequest {
