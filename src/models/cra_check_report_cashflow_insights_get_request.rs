...
pub struct CraCheckReportCashflowInsightsGetRequest {
    ...
    pub options: Option<Option<Box<models::CraCheckReportCashflowInsightsGetOptions>>>,
}

impl CraCheckReportCashflowInsightsGetRequest {
    /// CraCheckReportCashflowInsightsGetRequest defines the request schema for `/cra/check_report/cashflow_insights/get`.
    pub fn new() -> CraCheckReportCashflowInsightsGetRequest {
