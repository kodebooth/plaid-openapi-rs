...
pub struct ProcessorInvestmentsAuthGetRequest {
...
impl ProcessorInvestmentsAuthGetRequest {
    /// ProcessorInvestmentsAuthGetRequest defines the request schema for `/processor/investments/auth/get`
    pub fn new(processor_token: String) -> ProcessorInvestmentsAuthGetRequest {
