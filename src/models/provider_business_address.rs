...
pub struct ProviderBusinessAddress {
...
impl ProviderBusinessAddress {
    /// Detailed address information for a business from data provider
    pub fn new(street: Option<String>, street2: Option<String>, city: Option<String>, region: Option<String>, postal_code: Option<String>, country: String, is_primary: bool) -> ProviderBusinessAddress {
