...
pub struct CashflowReportMonthlySummaryAverageDailyNetCashflowAmount {
...
impl CashflowReportMonthlySummaryAverageDailyNetCashflowAmount {
    /// The average daily net cash flow amount, calculated as total daily inflows less total daily outflows.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryAverageDailyNetCashflowAmount {
