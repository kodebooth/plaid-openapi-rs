...
impl std::fmt::Display for AccountSubtype {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::LimitedPurposeChecking => write!(f, "limited purpose checking"),
            ...
            Self::Roth403B => write!(f, "roth 403B"),
            Self::Roth457b => write!(f, "roth 457b"),
            Self::RothPension => write!(f, "roth pension"),
            Self::RothProfitSharingPlan => write!(f, "roth profit sharing plan"),
            Self::RothThriftSavingsPlan => write!(f, "roth thrift savings plan"),
