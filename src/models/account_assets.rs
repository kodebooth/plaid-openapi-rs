...
pub struct AccountAssets {
    ...
    #[serde(rename = "account_insights", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub account_insights: Option<Option<models::AccountInsights>>,
}
