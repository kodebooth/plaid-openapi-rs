...
impl WalletTransactionStatusUpdateWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, transaction_id: String, new_status: models::WalletTransactionStatus, old_status: models::WalletTransactionStatus, timestamp: chrono::DateTime<chrono::FixedOffset>, environment: models::WebhookEnvironmentValues) -> WalletTransactionStatusUpdateWebhook {
