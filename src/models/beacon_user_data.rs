...
impl BeaconUserData {
    ...
    pub fn new(date_of_birth: chrono::NaiveDate, name: models::BeaconUserName, address: models::BeaconUserAddress, email_address: Option<String>, phone_number: Option<String>, id_number: Option<models::BeaconUserIdNumber>, ip_address: Option<String>, depository_accounts: Vec<models::BeaconUserDepositoryAccount>) -> BeaconUserData {
        BeaconUserData {
            date_of_birth,
            name,
            address,
