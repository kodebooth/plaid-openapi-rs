...
pub struct BusinessAccount {
    ...
    pub owners: Option<Vec<models::Owner>>,
}

impl BusinessAccount {
    /// Business identity information about an account
    pub fn new(account_id: String, balances: models::AccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>) -> BusinessAccount {
        BusinessAccount {
            account_id,
            balances,
            mask,
