...
pub struct CashflowReportHistoricalBalance {
...
impl CashflowReportHistoricalBalance {
    /// An object representing a balance held by an account in the past
    pub fn new(date: chrono::NaiveDate, amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportHistoricalBalance {
