...
pub struct CraCheckReportPartnerInsightsGetRequest {
    ...
    #[serde(rename = "user_tier", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub user_tier: Option<Option<models::CraUserTier>>,
    #[serde(rename = "partner_insights", skip_serializing_if = "Option::is_none")]
    pub partner_insights: Option<Box<models::CraCheckReportPartnerInsightsGetPartnerInsights>>,
