...
impl WatchlistScreeningSearchTerms {
    ...
    pub fn new(watchlist_program_id: String, legal_name: String, date_of_birth: Option<chrono::NaiveDate>, document_number: Option<String>, country: Option<String>, version: i32) -> WatchlistScreeningSearchTerms {
