...
pub struct CraVoaReportAccountBalances {
    ...
    pub historical_balances: Vec<models::CraVoaReportAccountHistoricalBalance>,
    /// The average balance in the account over the last 30 days. Calculated using the derived historical balances.
    #[serde(rename = "average_balance_30_days", deserialize_with = "Option::deserialize")]
    pub average_balance_30_days: Option<f64>,
    /// The average balance in the account over the last 60 days. Calculated using the derived historical balances.
    #[serde(rename = "average_balance_60_days", deserialize_with = "Option::deserialize")]
    pub average_balance_60_days: Option<f64>,
    ...
    #[serde(rename = "nsf_overdraft_transactions_count")]
    pub nsf_overdraft_transactions_count: f64,
}

impl CraVoaReportAccountBalances {
    /// VOA Report information about an account's balances.
    pub fn new(available: Option<f64>, current: Option<f64>, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, historical_balances: Vec<models::CraVoaReportAccountHistoricalBalance>, average_balance_30_days: Option<f64>, average_balance_60_days: Option<f64>, nsf_overdraft_transactions_count: f64) -> CraVoaReportAccountBalances {
