...
pub struct ItemWithConsentFields {
    ...
    #[serde(rename = "auth_method", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub auth_method: Option<Option<models::ItemAuthMethod>>,
...
impl ItemWithConsentFields {
    ...
    pub fn new(item_id: String, webhook: Option<String>, error: Option<models::PlaidError>, available_products: Vec<models::Products>, billed_products: Vec<models::Products>, consent_expiration_time: Option<chrono::DateTime<chrono::FixedOffset>>, update_type: UpdateType) -> ItemWithConsentFields {
