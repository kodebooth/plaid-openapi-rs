...
impl CraBankIncomeTransaction {
    ...
    pub fn new(transaction_id: String, amount: f64, date: chrono::NaiveDate, original_description: Option<String>, pending: bool, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CraBankIncomeTransaction {
