...
impl TransferIntentCreate {
    ...
    pub fn new(id: String, created: chrono::DateTime<chrono::FixedOffset>, status: models::TransferIntentStatus, origination_account_id: String, funding_account_id: String, amount: String, mode: models::TransferIntentCreateMode, user: models::TransferUserInResponse, description: String, iso_currency_code: String) -> TransferIntentCreate {
