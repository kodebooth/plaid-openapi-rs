...
impl BankTransferCreateRequest {
    ...
    pub fn new(idempotency_key: String, access_token: String, account_id: String, r#type: models::BankTransferType, network: models::BankTransferNetwork, amount: String, iso_currency_code: String, description: String, user: models::BankTransferUser) -> BankTransferCreateRequest {
