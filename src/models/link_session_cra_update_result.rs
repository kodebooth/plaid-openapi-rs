...
pub struct LinkSessionCraUpdateResult {
...
impl LinkSessionCraUpdateResult {
    /// The details of a Plaid Check Item update via Update Mode in Link.
    pub fn new(item_id: String, accounts: Vec<models::LinkSessionSuccessMetadataAccount>, institution: Option<models::LinkSessionSuccessMetadataInstitution>) -> LinkSessionCraUpdateResult {
