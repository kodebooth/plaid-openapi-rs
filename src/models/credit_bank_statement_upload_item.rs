...
impl CreditBankStatementUploadItem {
    ...
    pub fn new(item_id: String, bank_statements: Vec<models::CreditBankStatementUploadObject>, status: Option<models::PayrollItemStatus>, updated_at: Option<chrono::DateTime<chrono::FixedOffset>>) -> CreditBankStatementUploadItem {
