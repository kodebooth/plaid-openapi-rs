...
pub struct PaystubDetails {
    ...
    pub pay_period_start_date: Option<Option<chrono::NaiveDate>>,
    ...
    pub pay_period_end_date: Option<Option<chrono::NaiveDate>>,
    ...
    pub pay_date: Option<Option<chrono::NaiveDate>>,
