...
pub struct LinkTokenCreateRequestAccountSubtypes {
    ...
    pub depository: Option<Box<models::LinkTokenCreateDepositoryFilter>>,
    #[serde(rename = "credit", skip_serializing_if = "Option::is_none")]
    pub credit: Option<Box<models::LinkTokenCreateCreditFilter>>,
    #[serde(rename = "loan", skip_serializing_if = "Option::is_none")]
    pub loan: Option<Box<models::LinkTokenCreateLoanFilter>>,
    #[serde(rename = "investment", skip_serializing_if = "Option::is_none")]
    pub investment: Option<Box<models::LinkTokenCreateInvestmentFilter>>,
}
