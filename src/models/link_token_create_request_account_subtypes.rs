...
pub struct LinkTokenCreateRequestAccountSubtypes {
    ...
    pub depository: Option<models::LinkTokenCreateRequestAccountSubtypesDepository>,
    #[serde(rename = "credit", skip_serializing_if = "Option::is_none")]
    pub credit: Option<models::LinkTokenCreateRequestAccountSubtypesCredit>,
    #[serde(rename = "loan", skip_serializing_if = "Option::is_none")]
    pub loan: Option<models::LinkTokenCreateRequestAccountSubtypesLoan>,
    #[serde(rename = "investment", skip_serializing_if = "Option::is_none")]
    pub investment: Option<models::LinkTokenCreateRequestAccountSubtypesInvestment>,
}
