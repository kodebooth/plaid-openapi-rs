...
impl CreditBankEmploymentReport {
    ...
    pub fn new(bank_employment_report_id: String, generated_time: chrono::DateTime<chrono::FixedOffset>, days_requested: i32, items: Vec<models::CreditBankEmploymentItem>, warnings: Vec<models::CreditBankEmploymentWarning>) -> CreditBankEmploymentReport {
