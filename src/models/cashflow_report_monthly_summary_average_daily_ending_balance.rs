...
pub struct CashflowReportMonthlySummaryAverageDailyEndingBalance {
...
impl CashflowReportMonthlySummaryAverageDailyEndingBalance {
    /// Calendar-day average of the ending balance.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryAverageDailyEndingBalance {
