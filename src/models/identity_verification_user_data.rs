...
impl IdentityVerificationUserData {
    ...
    pub fn new(date_of_birth: Option<chrono::NaiveDate>, ip_address: Option<String>, email_address: Option<String>, name: Option<models::IdentityVerificationResponseUserName>, address: Option<models::IdentityVerificationUserAddress>, id_number: Option<models::UserIdNumber>) -> IdentityVerificationUserData {
