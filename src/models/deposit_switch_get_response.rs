...
impl DepositSwitchGetResponse {
    ...
    pub fn new(deposit_switch_id: String, target_account_id: Option<String>, target_item_id: Option<String>, state: State, account_has_multiple_allocations: Option<bool>, is_allocated_remainder: Option<bool>, percent_allocated: Option<f64>, amount_allocated: Option<f64>, date_created: chrono::NaiveDate, date_completed: Option<chrono::NaiveDate>, request_id: String) -> DepositSwitchGetResponse {
        DepositSwitchGetResponse {
            deposit_switch_id,
            target_account_id,
            target_item_id,
