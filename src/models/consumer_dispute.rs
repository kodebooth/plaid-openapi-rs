...
impl ConsumerDispute {
    ...
    pub fn new(consumer_dispute_id: String, dispute_field_create_date: chrono::NaiveDate, category: models::ConsumerDisputeCategory, statement: String) -> ConsumerDispute {
        ConsumerDispute {
            consumer_dispute_id,
