...
pub struct Security {
    ...
    #[serde(rename = "cfi_code", deserialize_with = "Option::deserialize")]
    ...
    #[serde(rename = "fixed_income", deserialize_with = "Option::deserialize")]
    pub fixed_income: Option<models::FixedIncome>,
}

impl Security {
    /// Contains details about a security
    pub fn new(security_id: String, isin: Option<String>, cusip: Option<String>, sedol: Option<String>, institution_security_id: Option<String>, institution_id: Option<String>, proxy_security_id: Option<String>, name: Option<String>, ticker_symbol: Option<String>, is_cash_equivalent: Option<bool>, r#type: Option<String>, close_price: Option<f64>, close_price_as_of: Option<chrono::NaiveDate>, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>, market_identifier_code: Option<String>, sector: Option<String>, industry: Option<String>, cfi_code: Option<String>, option_contract: Option<models::OptionContract>, fixed_income: Option<models::FixedIncome>) -> Security {
        Security {
            security_id,
            isin,
            cusip,
