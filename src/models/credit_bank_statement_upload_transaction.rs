...
impl CreditBankStatementUploadTransaction {
    ...
    pub fn new(amount: Option<f64>, date: Option<chrono::NaiveDate>, original_description: Option<String>, account_id: Option<String>) -> CreditBankStatementUploadTransaction {
