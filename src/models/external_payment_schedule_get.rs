...
impl ExternalPaymentScheduleGet {
    ...
    pub fn new(interval: models::PaymentScheduleInterval, interval_execution_day: i32, start_date: chrono::NaiveDate, end_date: Option<chrono::NaiveDate>, adjusted_start_date: Option<chrono::NaiveDate>) -> ExternalPaymentScheduleGet {
