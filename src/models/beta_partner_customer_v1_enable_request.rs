...
pub struct BetaPartnerCustomerV1EnableRequest {
...
impl BetaPartnerCustomerV1EnableRequest {
    /// Request schema for `/beta/partner/customer/v1/enable`.
    pub fn new(end_customer_client_id: String) -> BetaPartnerCustomerV1EnableRequest {
