...
pub struct LinkTokenInvestmentsAuth {
    ...
    #[serde(rename = "rollover_401k_enabled", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub rollover_401k_enabled: Option<Option<bool>>,
}
