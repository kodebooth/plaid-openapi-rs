...
pub struct InvestmentAccount {
    ...
    pub balances: Box<models::InvestmentAccountBalance>,
...
impl InvestmentAccount {
    ...
    pub fn new(account_id: String, balances: models::InvestmentAccountBalance, mask: Option<String>, name: String, official_name: Option<String>, r#type: models::AccountType, subtype: Option<models::AccountSubtype>) -> InvestmentAccount {
        InvestmentAccount {
            account_id,
