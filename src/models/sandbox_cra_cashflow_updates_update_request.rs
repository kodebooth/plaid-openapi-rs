...
pub struct SandboxCraCashflowUpdatesUpdateRequest {
    ...
    #[serde(rename = "webhook_codes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub webhook_codes: Option<Option<Vec<models::CashFlowUpdatesEventWebhookCodes>>>,
