...
pub struct TransferLedgerEventListRequest {
    ...
    #[serde(rename = "ledger_event_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub ledger_event_id: Option<Option<String>>,
    #[serde(rename = "source_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub source_type: Option<Option<models::LedgerEventSourceType>>,
...
impl TransferLedgerEventListRequest {
    /// Defines the request schema for `/transfer/ledger/event/list`
    pub fn new() -> TransferLedgerEventListRequest {
