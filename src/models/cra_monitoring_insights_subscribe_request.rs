...
pub struct CraMonitoringInsightsSubscribeRequest {
    ...
    #[serde(rename = "income_categories", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub income_categories: Option<Option<Vec<models::CreditBankIncomeCategory>>>,
...
impl CraMonitoringInsightsSubscribeRequest {
    ...
    pub fn new(webhook: String) -> CraMonitoringInsightsSubscribeRequest {
