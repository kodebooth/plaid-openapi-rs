...
pub struct WalletTransactionGetResponse {
    ...
    #[serde(rename = "payee_verification_status", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub payee_verification_status: Option<Option<models::WalletTransactionPayeeVerificationStatus>>,
...
impl WalletTransactionGetResponse {
    ...
    pub fn new(transaction_id: String, wallet_id: String, reference: String, r#type: Type, amount: models::WalletTransactionAmount, counterparty: models::WalletTransactionCounterparty, status: models::WalletTransactionStatus, created_at: chrono::DateTime<chrono::FixedOffset>, last_status_update: chrono::DateTime<chrono::FixedOffset>, request_id: String) -> WalletTransactionGetResponse {
        WalletTransactionGetResponse {
            transaction_id,
            wallet_id,
            reference,
            ...
            created_at,
            last_status_update,
            payee_verification_status: None,
            payment_id: None,
            failure_reason: None,
            error: None,
