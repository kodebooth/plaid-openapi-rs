...
pub struct EntityWatchlistScreeningHit {
    ...
    pub first_active: chrono::DateTime<chrono::FixedOffset>,
    /// An ISO8601 formatted timestamp.
    #[serde(rename = "inactive_since", deserialize_with = "Option::deserialize")]
    pub inactive_since: Option<chrono::DateTime<chrono::FixedOffset>>,
    /// An ISO8601 formatted timestamp.
    #[serde(rename = "historical_since", deserialize_with = "Option::deserialize")]
    pub historical_since: Option<chrono::DateTime<chrono::FixedOffset>>,
...
impl EntityWatchlistScreeningHit {
    ...
    pub fn new(id: String, review_status: models::WatchlistScreeningHitStatus, first_active: chrono::DateTime<chrono::FixedOffset>, inactive_since: Option<chrono::DateTime<chrono::FixedOffset>>, historical_since: Option<chrono::DateTime<chrono::FixedOffset>>, list_code: models::EntityWatchlistCode, plaid_uid: String, source_uid: Option<String>) -> EntityWatchlistScreeningHit {
