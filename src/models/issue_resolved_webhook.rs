...
pub struct IssueResolvedWebhook {
    ...
    pub issue_resolved_at: chrono::DateTime<chrono::FixedOffset>,
...
impl IssueResolvedWebhook {
    ...
    pub fn new(webhook_type: String, webhook_code: String, issue_id: String, issue_description: String, issue_resolved_at: chrono::DateTime<chrono::FixedOffset>, institution_id: String, institution_name: String) -> IssueResolvedWebhook {
