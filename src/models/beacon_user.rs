...
impl BeaconUser {
    ...
    pub fn new(item_ids: Vec<String>, id: String, version: i32, created_at: chrono::DateTime<chrono::FixedOffset>, updated_at: chrono::DateTime<chrono::FixedOffset>, status: models::BeaconUserStatus, program_id: String, client_user_id: String, user: models::BeaconUserData, audit_trail: models::BeaconAuditTrail) -> BeaconUser {
        BeaconUser {
            item_ids,
            id,
            version,
