...
impl DocumentaryVerificationDocument {
    ...
    pub fn new(status: models::DocumentStatus, attempt: i32, images: models::PhysicalDocumentImages, extracted_data: Option<models::PhysicalDocumentExtractedData>, analysis: models::DocumentAnalysis, redacted_at: Option<chrono::DateTime<chrono::FixedOffset>>) -> DocumentaryVerificationDocument {
