...
pub struct CashflowReportMonthlySummaryTotalRevenue {
...
impl CashflowReportMonthlySummaryTotalRevenue {
    /// The total amount of all revenue transactions during this month.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryTotalRevenue {
