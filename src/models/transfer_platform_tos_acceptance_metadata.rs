...
pub struct TransferPlatformTosAcceptanceMetadata {
    ...
    pub agreement_accepted_at: chrono::DateTime<chrono::FixedOffset>,
}

impl TransferPlatformTosAcceptanceMetadata {
    /// Metadata related to the acceptance of Terms of Service
    pub fn new(agreement_accepted: bool, originator_ip_address: String, agreement_accepted_at: chrono::DateTime<chrono::FixedOffset>) -> TransferPlatformTosAcceptanceMetadata {
