...
pub struct TotalReportInflowAmount90d {
...
impl TotalReportInflowAmount90d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportInflowAmount90d {
