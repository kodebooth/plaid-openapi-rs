...
impl PayStubPayPeriodDetails {
    ...
    pub fn new(pay_amount: Option<f64>, distribution_breakdown: Vec<models::PayStubDistributionBreakdown>, end_date: Option<chrono::NaiveDate>, gross_earnings: Option<f64>, iso_currency_code: Option<String>, pay_date: Option<chrono::NaiveDate>, pay_frequency: Option<String>, start_date: Option<chrono::NaiveDate>, unofficial_currency_code: Option<String>) -> PayStubPayPeriodDetails {
