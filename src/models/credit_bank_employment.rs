...
impl CreditBankEmployment {
    ...
    pub fn new(bank_employment_id: String, account_id: String, employer: models::CreditBankEmployer, latest_deposit_date: chrono::NaiveDate, earliest_deposit_date: chrono::NaiveDate) -> CreditBankEmployment {
