...
pub struct GamblingIndicators {
    ...
    #[serde(rename = "top_merchants", skip_serializing_if = "Option::is_none")]
    pub top_merchants: Option<Vec<String>>,
