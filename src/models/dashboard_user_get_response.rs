...
impl DashboardUserGetResponse {
    ...
    pub fn new(id: String, created_at: chrono::DateTime<chrono::FixedOffset>, email_address: String, status: models::DashboardUserStatus, request_id: String) -> DashboardUserGetResponse {
