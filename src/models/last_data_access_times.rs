...
pub struct LastDataAccessTimes {
    ...
    pub account_balance_info: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub account_routing_number: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub contact_details: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub transactions: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub credit_and_loans: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub investments: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub payroll_info: Option<chrono::DateTime<chrono::FixedOffset>>,
    ...
    pub transaction_risk_info: Option<chrono::DateTime<chrono::FixedOffset>>,
}

impl LastDataAccessTimes {
    /// Describes the last time each datatype was accessed by an application.
    pub fn new(application_id: String, account_balance_info: Option<chrono::DateTime<chrono::FixedOffset>>, account_routing_number: Option<chrono::DateTime<chrono::FixedOffset>>, contact_details: Option<chrono::DateTime<chrono::FixedOffset>>, transactions: Option<chrono::DateTime<chrono::FixedOffset>>, credit_and_loans: Option<chrono::DateTime<chrono::FixedOffset>>, investments: Option<chrono::DateTime<chrono::FixedOffset>>, payroll_info: Option<chrono::DateTime<chrono::FixedOffset>>, transaction_risk_info: Option<chrono::DateTime<chrono::FixedOffset>>) -> LastDataAccessTimes {
        LastDataAccessTimes {
            application_id,
