...
pub struct CreditBankEmploymentItem {
    ...
    pub last_updated_time: chrono::DateTime<chrono::FixedOffset>,
...
impl CreditBankEmploymentItem {
    ...
    pub fn new(item_id: String, last_updated_time: chrono::DateTime<chrono::FixedOffset>, institution_id: String, institution_name: String, bank_employments: Vec<models::CreditBankEmployment>, bank_employment_accounts: Vec<models::CreditBankIncomeAccount>) -> CreditBankEmploymentItem {
