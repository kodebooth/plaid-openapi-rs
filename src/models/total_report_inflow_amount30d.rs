...
pub struct TotalReportInflowAmount30d {
...
impl TotalReportInflowAmount30d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportInflowAmount30d {
