...
pub struct WalletTransactionExecuteRequest {
    ...
    #[serde(rename = "originating_fund_source", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub originating_fund_source: Option<Option<Box<models::OriginatingFundSource>>>,
}
