...
impl PaymentInitiationPayment {
    ...
    pub fn new(payment_id: String, amount: models::PaymentAmount, status: Status, recipient_id: String, reference: String, last_status_update: chrono::DateTime<chrono::FixedOffset>, schedule: Option<models::ExternalPaymentScheduleGet>, bacs: Option<models::SenderBacsNullable>, iban: Option<String>) -> PaymentInitiationPayment {
