...
impl NetworkInsightsReport {
    ...
    pub fn new(report_id: String, generated_time: chrono::DateTime<chrono::FixedOffset>, network_attributes: serde_json::Value, items: Vec<models::NetworkInsightsItem>) -> NetworkInsightsReport {
