...
impl BeaconReportSyndicationGetResponse {
    ...
    pub fn new(id: String, beacon_user_id: String, report: models::BeaconReportSyndicationOriginalReport, analysis: models::BeaconReportSyndicationAnalysis, request_id: String) -> BeaconReportSyndicationGetResponse {
