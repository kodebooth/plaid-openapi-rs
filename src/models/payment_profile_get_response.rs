...
impl PaymentProfileGetResponse {
    ...
    pub fn new(updated_at: chrono::DateTime<chrono::FixedOffset>, created_at: chrono::DateTime<chrono::FixedOffset>, deleted_at: Option<chrono::DateTime<chrono::FixedOffset>>, status: models::PaymentProfileStatus, request_id: String) -> PaymentProfileGetResponse {
