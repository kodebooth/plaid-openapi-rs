...
impl AssetReportItem {
    ...
    pub fn new(item_id: String, institution_name: String, institution_id: String, date_last_updated: chrono::DateTime<chrono::FixedOffset>, accounts: Vec<models::AccountAssets>) -> AssetReportItem {
        AssetReportItem {
            item_id,
            institution_name,
            institution_id,
