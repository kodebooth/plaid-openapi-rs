...
pub struct ExternalPaymentScheduleRequest {
    ...
    pub adjusted_start_date: Option<Option<chrono::NaiveDate>>,
}

impl ExternalPaymentScheduleRequest {
    /// The schedule that the payment will be executed on. If a schedule is provided, the payment is automatically set up as a standing order. If no schedule is specified, the payment will be executed only once.
    pub fn new(interval: models::PaymentScheduleInterval, interval_execution_day: i32, start_date: chrono::NaiveDate) -> ExternalPaymentScheduleRequest {
