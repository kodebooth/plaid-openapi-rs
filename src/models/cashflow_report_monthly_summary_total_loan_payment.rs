...
pub struct CashflowReportMonthlySummaryTotalLoanPayment {
...
impl CashflowReportMonthlySummaryTotalLoanPayment {
    /// The total amount of all loan payment transactions during this month.
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryTotalLoanPayment {
