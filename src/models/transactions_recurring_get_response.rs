...
impl TransactionsRecurringGetResponse {
    ...
    pub fn new(inflow_streams: Vec<models::TransactionStream>, outflow_streams: Vec<models::TransactionStream>, updated_datetime: chrono::DateTime<chrono::FixedOffset>, request_id: String) -> TransactionsRecurringGetResponse {
