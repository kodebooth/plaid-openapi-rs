...
pub struct CashflowReportMonthlySummaryEndingBalance {
...
impl CashflowReportMonthlySummaryEndingBalance {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> CashflowReportMonthlySummaryEndingBalance {
