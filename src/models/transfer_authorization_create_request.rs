...
pub struct TransferAuthorizationCreateRequest {
    ...
    #[serde(rename = "request_guarantee", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub request_guarantee: Option<Option<bool>>,
