...
pub struct TotalReportOutflowAmount90d {
...
impl TotalReportOutflowAmount90d {
    ...
    pub fn new(amount: f64, iso_currency_code: Option<String>, unofficial_currency_code: Option<String>) -> TotalReportOutflowAmount90d {
