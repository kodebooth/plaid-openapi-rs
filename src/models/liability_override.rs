...
impl LiabilityOverride {
    ...
    pub fn new(r#type: String, purchase_apr: f64, cash_apr: f64, balance_transfer_apr: f64, special_apr: f64, last_payment_amount: f64, minimum_payment_amount: f64, is_overdue: bool, origination_date: chrono::NaiveDate, principal: f64, nominal_apr: f64, interest_capitalization_grace_period_months: f64, repayment_model: models::StudentLoanRepaymentModel, expected_payoff_date: chrono::NaiveDate, guarantor: String, is_federal: bool, loan_name: String, loan_status: models::StudentLoanStatus, payment_reference_number: String, pslf_status: models::PslfStatus, repayment_plan_description: String, repayment_plan_type: String, sequence_number: String, servicer_address: models::Address) -> LiabilityOverride {
        LiabilityOverride {
            r#type,
            purchase_apr,
            cash_apr,
