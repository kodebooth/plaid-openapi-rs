...
pub struct ResponseBusinessAddress {
...
impl ResponseBusinessAddress {
    /// Physical address of a business. Used for response schemas.
    pub fn new(street: Option<String>, street2: Option<String>, city: Option<String>, region: Option<String>, postal_code: Option<String>, country: String) -> ResponseBusinessAddress {
