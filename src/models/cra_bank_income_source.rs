...
pub struct CraBankIncomeSource {
    ...
    pub next_payment_date: Option<Option<chrono::NaiveDate>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::CraBankIncomeStatus>,
...
impl CraBankIncomeSource {
    ...
    pub fn new(forecasted_average_monthly_income_prediction_intervals: Vec<models::CraPredictionInterval>, income_provider: Option<models::CraBankIncomeIncomeProvider>) -> CraBankIncomeSource {
        CraBankIncomeSource {
            account_id: None,
