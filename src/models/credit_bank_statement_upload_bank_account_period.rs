...
impl CreditBankStatementUploadBankAccountPeriod {
    ...
    pub fn new(start_date: Option<chrono::NaiveDate>, end_date: Option<chrono::NaiveDate>, starting_balance: Option<f64>, ending_balance: Option<f64>) -> CreditBankStatementUploadBankAccountPeriod {
